...
from .events import DeathsDoorEventLocationName as EL, DeathsDoorEventName as E, event_location_table, pot_table
...
pot_specific_rules : dict[EL, Rule["DeathsDoorWorld"]] = {
    ...
    EL.POT_HOOKSHOT_SILENT_SERVANT: Has(
